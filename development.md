...
**Комментарий:**
Здесь нет особенностей — стандартная CNN+MLP-архитектура без особых решений. Немного раздут MLP-блок по сравнению с основным агентом из-за присутствия большего количества фильтров.
